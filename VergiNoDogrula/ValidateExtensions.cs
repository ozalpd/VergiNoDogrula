...
/// <summary>
/// Provides extension methods for validating and comparing Turkish tax identification numbers (VKN and TCKN) for tax
/// payer entities and strings.
/// </summary>
/// <remarks>This static class includes methods to check the validity of Turkish tax numbers and to compare them
/// between different representations. The methods are designed to be used as extension methods on strings and objects
/// implementing the ITaxPayer interface. All validation logic follows the official rules for Turkish tax identification
/// numbers. These methods do not modify the input values and are thread-safe.</remarks>
